            ...
            <div class="row">
              <div class="col-12 mb-2">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" v-model="blog.titulo"></div>
              </div>

              <div class="form-floating">
                <textarea class="form-control" id="floatingTextarea" v-model="blog.contenido" style="height: 100px"></textarea>
